...
from .state import CharacterInfo, ListenConfig, RuntimeStatus, VoiceConfig
...
class RobotRuntime:
    ...
    def _load_settings_from_file(self) -> settings_store.AppSettings:
    ...
    async def on_listen_deactivate(self) -> None:
        ...
        if heard_text:
            await self.speak_from_prompt(heard_text)
