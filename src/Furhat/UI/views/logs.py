...
def build_logs_view(parent: tk.Frame) -> LogsView:
    ...
    transcript_text.grid(row=2, column=0, sticky="nsew")
    export_transcript_button.grid(row=3, column=0, sticky="w", pady=(8, 0))
    clear_transcript_button.grid(row=4, column=0, sticky="w", pady=(6, 0))
    system_log_label.grid(row=5, column=0, sticky="w", pady=(14, 6))
    logs_text.grid(row=6, column=0, sticky="nsew")
    clear_logs_button.grid(row=7, column=0, sticky="w", pady=(8, 0))
    export_diagnostics_button.grid(row=8, column=0, sticky="w", pady=(6, 0))
    open_validation_button.grid(row=9, column=0, sticky="w", pady=(6, 0))
