...
class UIStateStatusTests(unittest.TestCase):
    def _make_state(self) -> tuple[UIState, FakeRoot, FakeLabel]:
        ...
        settings = SettingsView(
            ...
            chat_max_tokens_value=SimpleNamespace(),
            chat_max_history_messages_value=SimpleNamespace(),
            chat_max_history_chars_value=SimpleNamespace(),
            llm_response_timeout_value=SimpleNamespace(),
            speech_max_sentences_value=SimpleNamespace(),
            speech_max_chars_value=SimpleNamespace(),
            speak_thinking_value=SimpleNamespace(),
            thinking_phrases_value=SimpleNamespace(),
            thinking_delay_value=SimpleNamespace(),
            thinking_repeat_value=SimpleNamespace(),
            thinking_wait_timeout_value=SimpleNamespace(),
            speak_wait_timeout_value=SimpleNamespace(),
            end_speech_timeout_value=SimpleNamespace(),
            listen_release_debounce_value=SimpleNamespace(),
            rag_embed_model_value=SimpleNamespace(),
            rag_top_k_value=SimpleNamespace(),
            rag_max_context_chars_value=SimpleNamespace(),
            rag_chunk_size_value=SimpleNamespace(),
            rag_chunk_overlap_value=SimpleNamespace(),
            rag_retrieval_timeout_value=SimpleNamespace(),
            web_enabled_value=SimpleNamespace(),
            web_port_value=SimpleNamespace(),
            public_max_text_chars_value=SimpleNamespace(),
            public_cooldown_value=SimpleNamespace(),
            disconnect_timeout_value=SimpleNamespace(),
        )
        logs = LogsView(
            frame=SimpleNamespace(),
            logs_text=DummyText(),
